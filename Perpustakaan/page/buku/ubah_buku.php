						...
						<div class="form-group">
							...
							<div class="form-group">
                                ...
                                <label class="radio-inline">
                                    <input type="radio" value="rak1" name="lokasi" <?php echo($lokasi=="rak1")?"checked":""?>/> Rak 1
                                </label>
                                <label class="radio-inline">
                                    <input type="radio" value="rak2" name="lokasi" <?php echo($lokasi=="rak2")?"checked":""?>/> Rak 2
                                </label>
                                <label class="radio-inline">
                                    <input type="radio" value="rak3" name="lokasi" <?php echo($lokasi=="rak3")?"checked":""?>/> Rak 3
                                </label>
                                </div>			
							<div class="form-group">
